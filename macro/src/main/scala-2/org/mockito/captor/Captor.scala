...
import org.mockito.internal.Scala2Version
import org.mockito.internal.Scala2Version.{ V2_12, V2_13 }

import scala.reflect.ClassTag
import scala.reflect.macros.blackbox

/**
 * Scala 2 version with macro-based stubbing operations.
 */
trait Captor[T] extends CaptorBase[T]

/** WrapperCaptor for Scala 2 - extends both WrapperCaptorBase and Captor trait */
...
object Captor {
  ...
  def materializeValueClassCaptorMacro[T: c.WeakTypeTag](c: blackbox.Context): c.Expr[Captor[T]] = {
    ...
    val r = if (isValueClass) c.Expr[Captor[T]] {
      ...
      val collectionConverters = Scala2Version.Current match {
