...
object WhenMacro {
  ...
  private def doTransformInvocation(using Quotes)(invocation: quotes.reflect.Term): quotes.reflect.Term = {
    ...
    if (hoisted.nonEmpty) Block(hoisted.toList, transformed) else transformed
  }
   ...
   */
  private def buildScalaFirstStubbing[T: Type](using Quotes)(transformed: quotes.reflect.Term): quotes.reflect.Term = {
    import quotes.reflect.*
  ...
  def shouldReturnMacro[T: Type](stubbing: Expr[T])(using Quotes): Expr[Any] = {
    import quotes.reflect.*
    buildActionWrapper[T]("org.mockito.IdiomaticMockitoBaseRuntime.ReturnActions", buildScalaFirstStubbing[T](doTransformInvocation(stubbing.asTerm)))
  }
  ...
  def shouldThrowMacro[T: Type](stubbing: Expr[T])(using Quotes): Expr[Any] = {
    import quotes.reflect.*
    buildActionWrapper[T]("org.mockito.IdiomaticMockitoBaseRuntime.ThrowActions", buildScalaFirstStubbing[T](doTransformInvocation(stubbing.asTerm)))
  }
  ...
  def shouldAnswerMacro[T: Type](stubbing: Expr[T])(using Quotes): Expr[Any] = {
    import quotes.reflect.*
    buildActionWrapper[T]("org.mockito.WhenMacroRuntime.AnswerActions", buildScalaFirstStubbing[T](doTransformInvocation(stubbing.asTerm)))
  }
  ...
  def shouldAnswerPFMacro[T: Type](stubbing: Expr[T])(using Quotes): Expr[Any] = {
    import quotes.reflect.*
    buildActionWrapper[T]("org.mockito.WhenMacroRuntime.AnswerPFActions", buildScalaFirstStubbing[T](doTransformInvocation(stubbing.asTerm)))
  }
