...
/**
 * Shared Scala 3 macro tree utilities used by `WhenMacro`, `DoSomethingMacro`, `VerifyMacro`, and `ExpectMacro`.
 *
 * Main responsibilities:
 *   - detect matcher expressions vs regular args
 *   - rewrite arguments into Mockito-friendly forms
 *   - handle Scala 3 inlining/named-arg/by-name quirks in one place
 */
object Utils {
