...
/**
 * Internal Scala 2 compatibility layer for `ResetMocksAfterEachTest`/`ResetMocksAfterEachAsyncTest`. Provides WeakTypeTag-based mock override methods that intercept mock creation
 * to track mocks for automatic reset.
 */
